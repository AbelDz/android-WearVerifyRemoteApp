...
public class MainWearActivity extends WearableActivity implements
    ...
    protected void onResume() {
        ...
        registerListenerAndVerifyApp();
    }

    private void registerListenerAndVerifyApp() {
        if (mCapabilityClient != null) {
            mCapabilityClient.addListener(this, CAPABILITY_PHONE_APP);
        }
    ...
    private void checkIfPhoneHasApp() {
        ...
        if (mCapabilityClient != null) {
            mCapabilityClient.getCapability(CAPABILITY_PHONE_APP, CapabilityClient.FILTER_ALL)
